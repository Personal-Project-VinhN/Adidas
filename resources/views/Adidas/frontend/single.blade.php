        ...
        <div class="cont span_2_of_3">
                ...
                <ul id="etalage">
                    <li>
                        <a href="optionallink.html">
                            <img class="etalage_thumb_image" src="{{ asset('/img/adidas/t1.jpg') }}" />
                            <img class="etalage_source_image" src="{{ asset('/img/adidas/t2.jpg') }}" />
                        </a>
                    </li>
                    <li>
                        <img class="etalage_thumb_image" src="{{ asset('/img/adidas/t2.jpg') }}" />
                        <img class="etalage_source_image" src="{{ asset('/img/adidas/t2.jpg') }}" />
                    </li>
                    <li>
                        <img class="etalage_thumb_image" src="{{ asset('/img/adidas/t3.jpg') }}" />
                        <img class="etalage_source_image" src="{{ asset('/img/adidas/t3.jpg') }}" />
                    </li>
                    <li>
                        <img class="etalage_thumb_image" src="{{ asset('/img/adidas/t4.jpg') }}" />
                        <img class="etalage_source_image" src="{{ asset('/img/adidas/t4.jpg') }}" />
                    </li>
                    <li>
                        <img class="etalage_thumb_image" src="{{ asset('/img/adidas/t5.jpg') }}" />
                        <img class="etalage_source_image" src="{{ asset('/img/adidas/t5.jpg') }}" />
                    </li>
                    <li>
                        <img class="etalage_thumb_image" src="{{ asset('/img/adidas/t6.jpg') }}" />
                        <img class="etalage_source_image" src="{{ asset('/img/adidas/t6.jpg') }}" />
                    </li>
                    <li>
                        <img class="etalage_thumb_image" src="{{ asset('/img/adidas/t1.jpg') }}" />
                        <img class="etalage_source_image" src="{{ asset('/img/adidas/t1.jpg') }}" />
                    </li>
                </ul>
            ...
            <div class="cont1 span_2_of_a1">
                ...
                <ul class="add-to-links">
                    <li><img src="{{ asset('/img/adidas/wish.png') }}" alt="" /><a href="#">Add to wishlist</a></li>
                </ul>
            ...
            <ul id="flexiselDemo3">
                <li><img src="{{ asset('/img/adidas/pic11.jpg') }}" />
                    <div class="grid-flex"><a href="#">Bloch</a>
                        <p>Rs 850</p>
                    </div>
                </li>
                <li><img src="{{ asset('/img/adidas/pic10.jpg') }}" />
                    <div class="grid-flex"><a href="#">Capzio</a>
                        <p>Rs 850</p>
                    </div>
                </li>
                <li><img src="{{ asset('/img/adidas/pic9.jpg') }}" />
                    <div class="grid-flex"><a href="#">Zumba</a>
                        <p>Rs 850</p>
                    </div>
                </li>
                <li><img src="{{ asset('/img/adidas/pic8.jpg') }}" />
                    <div class="grid-flex"><a href="#">Bloch</a>
                        <p>Rs 850</p>
                    </div>
                </li>
                <li><img src="{{ asset('/img/adidas/pic7.jpg') }}" />
                    <div class="grid-flex"><a href="#">Capzio</a>
                        <p>Rs 850</p>
                    </div>
                </li>
            ...
            <script type="text/javascript" src="{{ mix('js/adidas/jquery.flexisel.js')}}"></script>
            <div class="toogle">
